...
@section('content')
<h1 class="h3 mb-2 text-gray-800">Suket Kematian Pasien (IGD)</h1>
<p>RS PINDAD</p>
<!-- DataTales Example -->
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <div class="row">
        <div class="col">
        <h6 class="m-0 font-weight-bold text-primary">Create Suket Kematian (IGD)</h6>
        </div>
    ...
    <div class="card-body">
          <form method="POST" action="{{route('suket_kematian_igd.store')}}">
            @csrf
            <div class="form-group row">
              <label for="no_medrek" class="col-sm-2 col-form-label">No Rekam Medis</label>
              <div class="col-sm-6">
                <input type="text" name="no_medrek" class="form-control" id="no_medrek" placeholder="no rekam medis" required>
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                ...
                <a href="{{route('suket_kematian_igd.index')}}"  class="btn btn-secondary">Batal</a>
