...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <div class="row">
        <div class="col">
        <h6 class="m-0 font-weight-bold text-primary">Edit Kategori Kelas Ruangan</h6>
        </div>
    ...
    <div class="card-body">
          <form method="POST" action="{{route('kategori_kelasruangan.update', $edit->id)}}">
            @csrf
            @method('PUT')
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                <select name="id_kelas" class="form-control theSelect" required>
                  ...
                  <option value="{{$item->id}}" {{ $item->id == $edit->id_kelas ? 'selected' : '' }} class="form-control">{{$item->kelas}}</option>
                  @endforeach
              </select>
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                <input type="text" name="ruangan" value="{{$edit->ruangan}}" class="form-control" id="ruangan" placeholder="ruangan" required>
              </div>
            </div>
            <div class="form-group row">
