...
@section('content')
<h1 class="h3 mb-2 text-gray-800">Edit Kategori Dokter</h1>
<p>RS PINDAD</p>
<!-- DataTales Example -->
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <div class="row">
        <div class="col">
        <h6 class="m-0 font-weight-bold text-primary">Edit Kategori Dokter</h6>
        </div>
    ...
    <div class="card-body">
          <form method="POST" action="{{route('kategori_dokter.update', $edit->id)}}">
            @csrf
            @method('PUT')
