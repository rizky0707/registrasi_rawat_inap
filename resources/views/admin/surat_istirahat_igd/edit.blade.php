...
@section('content')
<h1 class="h3 mb-2 text-gray-800">Surat Istirahat Pasien (IGD)</h1>
<p>RS PINDAD</p>
<!-- DataTales Example -->
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <div class="row">
        <div class="col">
        <h6 class="m-0 font-weight-bold text-primary">Edit Istirahat Pasien (IGD)</h6>
        </div>
    ...
    <div class="card-body">
          <form method="POST" action="{{route('surat_istirahat_igd.update', $edit->id)}}">
            @csrf
            @method('PUT')
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-3">
                <input type="text" name="golongan" value="{{$edit->golongan}}" class="form-control" id="golongan" placeholder="golongan" required>
              </div>
            </div>
            <div class="form-group row">
              <label for="jabatan" class="col-sm-2 col-form-label">Jabatan</label>
              <div class="col-sm-3">
                <input type="text" name="jabatan" value="{{$edit->jabatan}}" class="form-control" id="jabatan" placeholder="jabatan" required>
              </div>
              <div class="col-sm-3">
                <input type="number" name="unit" value="{{$edit->unit}}" class="form-control" id="unit" placeholder="unit" required>
              </div>
            </div>
            <div class="form-group row">
              <label for="lama_istrirat_mulai" class="col-sm-2 col-form-label">Lama Istirahat</label>
              <div class="col-sm-3">
                <input type="text" name="lama_istirahat_mulai" value="{{$edit->lama_istirahat_mulai}}" placeholder="mulai" class="form-control" id="lama_istrirat_mulai" required>
              </div>
              <div class="col-sm-3">
                <input type="date" name="lama_istirahat_akhir" value="{{$edit->lama_istirahat_akhir}}" class="form-control" id="lama_istrirat_akhir" required>
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                ...
                <a href="{{route('surat_istirahat_igd.index')}}"  class="btn btn-secondary">Batal</a>
