    ...
    <div class="row">
      <div class="col-lg-10 col-lg-offset-1" style="margin-top:20px; text-align: right">
        <div class="btn-group mb-4">  
          <a href="{{route('surat_istirahat_igd.index')}}" class="btn btn-primary">Back</a>
          </div>
        <div class="btn-group mb-4">  
          <a href="{{route('surat_igd_pdf', $surat_dokter_igd->id)}}" class="btn btn-success">Save as PDF</a>
        </div>
      ...
      <div class="col-lg-10 col-lg-offset-1">
          ...
          <div class="invoice">
            ...
            <div class="halaman">
              ...
              <center><p>No. Surat : {{$surat_dokter_igd->no_surat}}</p></center>
              <br><br>
              <p>Diberitahuakan bahwa</p>
              <table width="100%" border="0" cellspacing="2" cellpadding="5">
                <tr>
                  <td>Nama</td>
                  <td colspan="2">: {{$surat_dokter_igd->nama}}</td>
                </tr>
                <tr>
                  <td>Umur</td>
                  <td colspan="2">: {{$surat_dokter_igd->umur}}</td>
                </tr>
                <tr>
                  <td>Pangkat/Gol.</td>
                  <td colspan="2">: {{$surat_dokter_igd->golongan}}</td>
                </tr>
                <tr>
                  <td>NIP/NRP/NPP</td>
                  <td colspan="2">: ...............</td>
                ...
                <tr>
                  <td>J a b a t a n</td>
                  <td colspan="2">: {{$surat_dokter_igd->jabatan}}</td>
                </tr>
                <tr>
                  <td>Bagian/Unit</td>
                  <td colspan="2">: {{$surat_dokter_igd->unit}}</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td>Selama </td>
                  <td colspan="2">: {{$surat_dokter_igd->lama_istirahat_mulai}}</td>
                </tr>
                <tr>
                  <td>Mulai</td>
                  <td colspan="2">: {{$surat_dokter_igd->lama_istirahat_akhir}}</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    <center style="padding-right: 0px; padding-left: 300px;">  
                      <?php 
                      $date = $surat_dokter_igd->created_at;
                      ?>
